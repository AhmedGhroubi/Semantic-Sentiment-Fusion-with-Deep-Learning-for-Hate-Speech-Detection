...
This repository contains the official implementation of our paper, **"Semantic-Sentiment Fusion with Deep Learning: A Novel Framework for Hate Speech Detection,"** published in *Computers, Materials & Continua (CMC)*. The proposed framework combines semantic representations from **BERT** with sentiment features extracted from **VADER** and **LIWC-22**, enabling robust hate speech detection through semantic-sentiment feature fusion. The framework is evaluated using CNN, LSTM, and DNN classifiers across multiple benchmark datasets.

## Paper

**Semantic-Sentiment Fusion with Deep Learning: A Novel Framework for Hate Speech Detection**  
Choongwon Kang, Haein Lee, and Jang Hyun Kim  
*Computers, Materials & Continua (CMC), 2026*

📄 Paper: https://www.techscience.com/cmc/v88n1/67306
